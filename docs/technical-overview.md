...
**Full Protocol:** `D:\temp\myprojects\spine\_protocols\SPINE-INIT.md`
**WSL:** `/mnt/d/temp/myprojects/spine/_protocols/SPINE-INIT.md`
...
- **Dependencies:** 0
- **Languages Used:** 
- **Last Analysis:** 2026-02-22 18:19:02
<!-- AUTO-UPDATE-END -->
...
- `src/mcp/` — FastMCP server (13 tools for AI assistants)
- `src/registry.py` — Multi-project management
- `src/web/` — FastAPI backend (~16 REST endpoints) + React frontend (Sigma.js graph explorer)
...
**Status:** All phases complete (1-12 + Batch Summaries + Code Quality Metrics), 734 tests, 27 projects indexed.
<!-- CUSTOM-END -->
...
- **Project Type Detected:** Unknown Project
- **Primary Technology:** Unknown
